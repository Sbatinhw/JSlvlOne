...
let prevNavLink = document.querySelector(".nav-link, .active");
...
function changeText(event) {
    textElem.innerHTML = texts["text" + prevNavLink.textContent[prevNavLink.textContent.length - 1]];
}